...
// theme breadcrumb
const page = ref({ title: 'Gestions des services' });
        ...
        if (valid) {
            ...
            store
                ...
                .then((response) => {
                    ...
                    snackbarStore.showSuccess(t('Service sauvée avec succès'));
                })
                .catch((error) => {
                    saving.value = false;
...
const formTitle = computed(() => {
    return editedIndex.value === -1 ? t('Nouvel service') : t('Modifier la service');
});
