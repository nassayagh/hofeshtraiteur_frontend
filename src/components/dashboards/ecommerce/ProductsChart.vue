...
const Chart2 = computed(() => {
    return {
        ...
        grid: {
            show: false,
            padding: { left:20, right: 0, bottom: 0 },
    ...
    <v-card elevation="10">
        <v-card-text class="pb-3">
            <div class="d-sm-flex align-center mb-5">
                <h2 class="text-h4">Products Performance</h2>
                <v-spacer></v-spacer>
                <div>
            ...
            <v-row>
                <v-col lg="4" cols="12">
                    <h3 class="text-h4 mt-3">$93,438.78</h3>
                    <span class="text-subtitle-1 pt-3 text-medium-emphasis font-weight-medium">Budget</span>

                    <h3 class="text-h4 mt-6">$32,839</h3>
                    <span class="text-subtitle-1 pt-3 text-medium-emphasis font-weight-medium">Expense</span>
